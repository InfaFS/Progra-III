...
public class TestAnimal3 {
    public static void main(String[] args) {
        ...
        animal3.saludo();
        //
        Perro perro2 = (Perro)animal2; //tenemos que poner (Nombre de clase que le vamos a hacer downcasting) nombre_variable
        ...
        //Animal animalito = new Animal(); //no puedo crear un objeto de tipo animal solamente ya que la clase animal es abstracta
    }
}